        ...
        <ButtonStoreProvider>
          <ThemeProvider defaultTheme={defaultTheme}>
            ...
            <ProgressBarProviders>
              {children}
              {modal}
              <footer className="pointer-events-none fixed right-3 top-11 z-40 hidden text-[10px] leading-none text-white/46 drop-shadow-[0_1px_8px_rgba(0,0,0,0.45)] lg:flex">
