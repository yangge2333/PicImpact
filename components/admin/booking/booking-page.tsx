...
function initialCreateForm(studioId = ''): CreateForm {
  return {
    selections: [{ id: 1, studioId, date: addDays(startOfToday(), 1), startMinutes: 600, endMinutes: 720 }],
    contactType: 'phone',
    contactValue: '',
    customerName: '',
    note: '',
