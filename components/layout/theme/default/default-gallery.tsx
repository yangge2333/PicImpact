...
function EditorialHero({
  ...
  const channelLabels = [
    { name: '正片', detail: '精选出片', href: '/zhengpian', icon: ImageIcon },
    { name: '场照', detail: '现场纪实', href: '/changzhao', icon: Camera },
    { name: '旅拍', detail: '旅途随拍', href: '/lvpai', icon: Plane },
  ]
    ...
    <section className="relative -mt-10 min-h-[100svh] overflow-hidden bg-stone-950 text-white">
      ...
      <div className="pointer-events-none relative z-10 flex min-h-[100svh] items-end px-4 pb-[max(1rem,env(safe-area-inset-bottom))] pt-14 sm:px-8 sm:pb-8 sm:pt-20 md:pb-8 lg:px-14 lg:pb-7">
        ...
        >
          ...
          <div className="mt-1 grid w-full max-w-[23rem] grid-cols-3 gap-2.5 sm:mt-3 sm:max-w-[34rem] sm:gap-3 md:max-w-[36rem]">
                ...
                >
                  ...
                  <span className="relative flex items-center gap-2.5 sm:gap-3.5">
                    ...
                    <span className="min-w-0">
                      ...
                      <span className="mt-1.5 block text-[9px] leading-3 text-white/68 sm:text-[11px] sm:leading-4">
                        {item.detail}
                      </span>
                    </span>
                  </span>
